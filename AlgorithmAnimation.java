...
public class AlgorithmAnimation extends JApplet {
    ...
    public AlgorithmAnimation() {
        ...
        sortPanels[0] = new BubbleSortPanel(" Bubble Sort ", list, sleepTime);
        sortPanels[1] = new SelectionSortPanel(" Selection Sort ", list, sleepTime);
        sortPanels[2] = new InsertionSortPanel(" Insertion Sort ", list, sleepTime);
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("Assignment11");
        JApplet applet = new AlgorithmAnimation();
        frame.add(applet);
